export default function Realms() {
    ...
    const realmHeading = 'text-xl sm:text-2xl tracking-wide font-semibold mb-2';
    return (
        <section id="realms" className="flex flex-col gap-12 max-w-360">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <article className={realms}>
                    ...
                    <p className="sm:text-lg">Where it all began. Before Light turned on Dark, before the balance broke —
                ...
                <article className={realms}>
                    ...
                    <p className="sm:text-lg">Whatever Light became after it won, this is where it lives. Hostile, twisted,
                ...
                <article className={realms}>
                    ...
                    <p className="sm:text-lg">Your very own realm, shaped by you. The one realm shaped entirely by you.
                ...
                <article className={realms}>
                    ...
                    <p className="sm:text-lg">The awaited battle, the world deserves to be saved and its gaze is upon you.
